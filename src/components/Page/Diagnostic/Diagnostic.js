            ...
            <div class="row row-cols-3">
              <div class="col">
                ...
                লোকেশন :
                  <input
                    type="text"
                    class="form-control doctor-filter-input"
                    placeholder="লোকেশন"
                  ></input>
                </p>
              </div>
              ...
              <div class="col">
                ...
                রেটিং :
                  <select
                    class="form-select doctor-filter-form-select"
            ...
            <div className="col">
              <div className="card h-100 shadow-lg overflow-hidden  bg-body rounded border-0">
                ...
                <div className="card-body">
                  ...
                  <p>
                    It is an entertainment universe, every human being needs
                  </p>
                </div>
              </div>
            </div>
